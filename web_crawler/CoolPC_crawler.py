...
def GetAllData2CSV():
    ...
    for i in range (len(data_name_select)):
        ...
        df = pd.DataFrame(all_data_list_cpu)
        df.to_csv("./web_crawler/coolpc_data_noclean_{}.csv".format(data_name[i]))
...
def OriginalPriceData_CPU():
    ...
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_CPU.csv")
    ...
    df.to_csv("./web_crawler/clean_coolpc_cpu_data_new.csv")
...
def OriginalPriceData_GPU():
    ...
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_GPU.csv")
    data_array = np.array(data)
    ...
    for row in data_array:
        ...
        vram = f"{vram_match.group(1)}" if vram_match else ""
    ...
    df.to_csv("./web_crawler/clean_coolpc_GPU_data_new.csv")
...
def OriginalPriceData_MB():
    ...
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_MB.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_MB_data_new.csv")
...
def OriginalPriceData_RAM():
    ...
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_RAM.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_RAM_data_new.csv")
...
def OriginalPriceData_Cooler():
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_cooler.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_cooler_data_new.csv")

# OriginalPriceData_Cooler()


def OriginalPriceData_PSU():
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_PSU.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_PSU_data_new.csv")

# OriginalPriceData_PSU()


def OriginalPriceData_storage():
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_storage.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_storage_data_new.csv")

# OriginalPriceData_storage()

def OriginalPriceData_case():
    data = pd.read_csv("./web_crawler/coolpc_data_noclean_case.csv")
    data_array = np.array(data)
    ...
    df.to_csv("./web_crawler/clean_coolpc_case_data_new.csv")
